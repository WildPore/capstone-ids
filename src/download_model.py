...
def download_and_unzip():
    ...
    zip_path = get_project_root() / "data" / "MachineLearningCSV.csv"
    md5_path = Path("MachineLearningCSV.md5")
...
def verify_md5(file_path, expected_mp5):
...
# download if there is no file already
# if file already, download md5 and check...
